...
public class GraphicsController {
	...
	private Shader shaderCode=Shader.CONSTANT;
	private boolean zBufferEnabled=false;
	...
	public void enableConstantShading(){
		this.shaderCode=Shader.CONSTANT;;
	}

	public void enableGouraudsMethodShading(){
		this.shaderCode=Shader.GOURAUDS_METHOD;;
	}
	...
	public boolean useConstantShading() {
		return this.shaderCode==Shader.CONSTANT;
	}

	public boolean useSmoothShading() {
		return this.shaderCode==Shader.GOURAUDS_METHOD;
	}

	public void toggleZBuffer() {
		this.zBufferEnabled=(zBufferEnabled)?false:true;
	}

	public boolean isZBufferEnabled(){
		return this.zBufferEnabled;
	}
}
