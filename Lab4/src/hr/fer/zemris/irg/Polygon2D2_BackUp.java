 ...
 *
 */
public class Polygon2D2_BackUp {
	 ...
	 */
	public Polygon2D2_BackUp(IVector... points) {
	 ...
	 */
	public Polygon2D2_BackUp(LinkedList<IVector> points) {
	...
	public boolean add(IVector nextPoint) {
		if (elements.size() < 2) {
			...
			list.add(nextPoint);
			Polygon2D2_BackUp poly = new Polygon2D2_BackUp(list);
	...
	public void tryDrawFilled(GL2 gl2, IVector curMouse) throws IllegalArgumentException {
		if (this.checkConvex(curMouse)) {
			Polygon2D2_BackUp copy = this.duplicate();
			copy.add(curMouse);
			copy.drawFilled(gl2);
		} else
			throw new IllegalArgumentException(
	...
	public void drawFilled(GL2 gl2) {
		...
		if (this.isClockwise) {
			...
			Polygon2D2_BackUp poly = new Polygon2D2_BackUp(points);
			poly.drawFilled(gl2);
			return;
		}
		int i, i0, y;
	 ...
	 */
	public Polygon2D2_BackUp duplicate() {
		Polygon2D2_BackUp clone = new Polygon2D2_BackUp();
